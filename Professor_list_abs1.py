...
driver.get("https://www.ratemyprofessors.com/search/teachers?query=*&sid=567")
...
c = 0
show_more_button = driver.find_element_by_xpath('/html/body/div[2]/div/div/div[4]/div[1]/div[4]/button')
try:
...
df.to_csv('Marshall University.csv')
